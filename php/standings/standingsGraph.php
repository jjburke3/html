...
round(standPoints/(13*standRunCount),2) as pointAverage, 
round(standPoints/(13*standRunCount),2) as exPointAverage, 
round(standPointsRemain/(standRunCount*least(16,17-standWeek)),2) as exRemainPointAverage, 
